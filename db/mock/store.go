...
// Source: github.com/djsmk123/simplebank/db/sqlc (interfaces: Store)
...
// Transferx mocks base method.
func (m *MockStore) Transferx(arg0 context.Context, arg1 db.TransfersTxParams) (db.TranferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Transferx", arg0, arg1)
	ret0, _ := ret[0].(db.TranferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Transferx indicates an expected call of Transferx.
func (mr *MockStoreMockRecorder) Transferx(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Transferx", reflect.TypeOf((*MockStore)(nil).Transferx), arg0, arg1)
}
